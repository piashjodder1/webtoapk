...
<head>
    ...
    <title>Log in - {{ \App\Models\Setting::get('seo_title', config('app.name', 'Website To App Builder')) }}</title>
        ...
        <main class="relative z-10 flex items-center justify-center px-4 py-20">
            <div class="w-full max-w-md">
                <div class="rounded-3xl border border-slate-200 bg-white/80 backdrop-blur-xl p-6 sm:p-10 shadow-xl shadow-primary-600/10">
                    <h1 class="text-3xl font-bubblegum text-gray-900 text-center">Welcome back</h1>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-6 space-y-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('password.request') }}" class="text-sm font-bold text-primary-600 hover:text-primary-700">Forgot password?</a>
                        </div>
                        <button type="submit"
                    ...
                    <p class="mt-6 text-center text-sm text-gray-500">
                        ...
                        <a href="{{ route('register') }}" class="font-bold text-primary-600 hover:text-primary-700 transition">Register</a>
                    </p>
                </div>
            </div>
        </main>
